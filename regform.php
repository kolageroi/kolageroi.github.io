...
<div class="nav">
    ...
    <br>
            ...
            ?>
    <input placeholder="Проверка пароля" class="lp" minlength="8"  type="password" id="passcheck" name="passwordcheck" required title="Паролі відрізняюця">
    <br>
    <input type="submit" name="send" class="but" value="Зарегестрироваться"/>

    </form>
    </div>
    <h3>Уже есть акккаунт? <a href="logform.php" style="color: darkturquoise;">Войти</a></h3>
</div>
